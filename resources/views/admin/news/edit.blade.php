...
<div class="form-card">
    <form method="POST" 
        ...
        <!-- News Description with Quill Editor -->
        <div class="form-group">
            ...
            <div class="help-text">
                <i class="fas fa-info-circle"></i>
                Provide comprehensive details about the news. You can add images by clicking the image icon in the toolbar.
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            @if($news->image)
                <div class="image-preview-section">
                    <p>Current image:</p>
                    <img src="{{ asset('storage/' . $news->image) }}" alt="{{ $news->title }}" class="img-preview" id="currentImage">
                </div>
            @endif
        ...
        <div class="form-group">
            ...
            <input 
                ...
                id="published_date" 
                name="published_date"
                value="{{ old('published_date', $news->published_date ? $news->published_date->format('Y-m-d') : '') }}">
        ...
        <div class="form-group">
            <div class="checkbox-group">
                ...
                <label for="status">
                    ...
                    Publish this news (Make it visible to users)
                </label>
            </div>
        </div>
